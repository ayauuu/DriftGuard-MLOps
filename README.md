...
git clone https://github.com/your-username/drift-guard-mlops.git
...
## 📊 How It Works
1. The FastAPI backend loads the baseline reference.csv and incoming current.csv.
2. Evidently AI computes statistical metrics and generates both a detailed interactive visual report (drift_report.html) and structured JSON results.
3. The frontend dashboard polls the API every 5 seconds, giving engineers instant visibility into dataset stability.
